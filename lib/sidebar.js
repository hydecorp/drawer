...
var Sidebar = function (_HTMLElement) {
  ...
  _createClass(Sidebar, [{
    ...
    value: function getNearestTouch(touches) {
      ...
      return Array.prototype.reduce.call(touches, function (acc, touch) {
        var dist = _this2.distanceToLastTouch(touch);
        ...
        case TOUCHING:
          {
            ...
            if (timeDiff > 0) {
              this.velocity = VELOCITY_LINEAR_COMBINATION * (this.pageX - this.lastPageX) / timeDiff + (1 - VELOCITY_LINEAR_COMBINATION) * this.velocity;
            }
