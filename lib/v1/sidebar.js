(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g=(g.y||(g.y = {}));g=(g.sidebar||(g.sidebar = {}));g.v1 = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
var _webcomponents = require('../webcomponents');
...
var SidebarV1 = function (_SidebarCore) {
  _inherits(SidebarV1, _SidebarCore);

  function SidebarV1() {
    _classCallCheck(this, SidebarV1);

    return _possibleConstructorReturn(this, (SidebarV1.__proto__ || Object.getPrototypeOf(SidebarV1)).apply(this, arguments));
  }

  _createClass(SidebarV1, [{
    key: 'setupDOM',
    value: function setupDOM(el) {
      el.attachShadow({ mode: 'open' });

      // TODO: better why to get template?
      var instance = document.querySelector('link[href$="v1/sidebar.html"]').import.getElementById('y-sidebar-template').content.cloneNode(true);
...
exports.default = SidebarV1;


customElements.define('y-sidebar-v1', function (_SidebarHTMLElement) {
  _inherits(_class, _SidebarHTMLElement);
  ...
  return _class;
}(_webcomponents2.default));

},{"../core/sidebar":1,"../webcomponents":3}],3:[function(require,module,exports){
'use strict';
...
function isTruthyAttrVal(v) {
  return v != null && v !== 'false' && v !== 'null' && v !== 'undefined' && v !== '0';
}

// TODO: can these tasks be automated!?

var SidebarHTMLElement = function (_HTMLElement) {
  _inherits(SidebarHTMLElement, _HTMLElement);

  function SidebarHTMLElement() {
    _classCallCheck(this, SidebarHTMLElement);

    return _possibleConstructorReturn(this, (SidebarHTMLElement.__proto__ || Object.getPrototypeOf(SidebarHTMLElement)).apply(this, arguments));
  }

  _createClass(SidebarHTMLElement, [{
    key: 'reflectAttributeChanges',
    value: function reflectAttributeChanges() {
      var _this2 = this;

      this.addEventListener('menuopenchange', function (_ref) {
        ...
        _this2.silenthack = true;

        if (detail) {
          _this2.setAttribute('menu-open', 'menu-open');
        } else {
          _this2.removeAttribute('menu-open');
        }
      });
    }
  }, {
  ...
  return SidebarHTMLElement;
}(HTMLElement);

exports.default = SidebarHTMLElement;
