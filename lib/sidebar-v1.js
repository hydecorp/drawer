  ...
  _createClass(SidebarCore, [{
    ...
    value: function onAnimationFrame(time) {
      switch (this.state) {
        ...
        case ANIMATING:
          {
            var t = time - this.animationStartTime;
            if (t < DURATION) {
              this.startTranslateX = linearTween(t, this.animationStartX, this.animationChangeInValue, DURATION);
              requestAnimationFrame(this.onAnimationFrame);
            } else {
              // end animation
...
var _sidebarCore = require('./sidebar-core');

var _sidebarCore2 = _interopRequireDefault(_sidebarCore);
...
var SidebarV1 = function (_SidebarCore) {
  ...
  _createClass(SidebarV1, [{
    ...
    value: function setupDOM(el) {
      ...
      var instance = document.querySelector('link[href$="sidebar-v1.html"]').import.getElementById('x-sidebar-template').content.cloneNode(true);
  ...
  return SidebarV1;
}(_sidebarCore2.default);

exports.default = SidebarV1;


window.customElements.define('y-sidebar-v1', function (_HTMLElement) {
