var _initialized, _translateX$, _startTranslateX$, _tweenTranslateX$;
...
let HyDrawer = class HyDrawer extends applyMixins(RxLitElement, [ObservablesMixin, UpdateMixin, CalcMixin]) {
    constructor() {
        ...
        _translateX$.set(this, void 0);
        _startTranslateX$.set(this, void 0);
        _tweenTranslateX$.set(this, void 0);
        this.upgrade = () => {
            ...
            const isScrimVisible$ = defer(() => {
                return __classPrivateFieldGet(this, _translateX$).pipe(map(translateX => translateX !== 0));
            });
            ...
            const translateX$ = __classPrivateFieldSet(this, _translateX$, defer(() => {
                ...
                const moveTranslateX$ = move$.pipe(filterWhen(isSliding$), tap(() => (this.scrimClickable = false)), tap(({ event }) => event && this.noScroll && event.preventDefault()), withLatestFrom(start$, __classPrivateFieldGet(this, _startTranslateX$), drawerWidth$), map(args => this.calcTranslateX(...args)));
                return merge(__classPrivateFieldGet(this, _tweenTranslateX$), jumpTranslateX$, moveTranslateX$);
            }).pipe(share()));
            __classPrivateFieldSet(this, _startTranslateX$, translateX$.pipe(sample(start$)));
            ...
            __classPrivateFieldSet(this, _tweenTranslateX$, merge(willOpen$, animateTo$).pipe(withLatestFrom(translateX$, drawerWidth$), switchMap(([willOpen, translateX, drawerWidth]) => {
            ...
            switchMap(mouseEvents => {
                return mouseEvents
                    ...
                    : NEVER;
            }), filter(([coord, isInRange]) => isInRange && coord.event != null), tap(([{ event }]) => event && event.preventDefault())).subscribe();
...
_initialized = new WeakMap(), _translateX$ = new WeakMap(), _startTranslateX$ = new WeakMap(), _tweenTranslateX$ = new WeakMap();
