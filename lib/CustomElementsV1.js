...
(function () {
  ...
  CustomElementsRegistry.prototype = {
     ...
     * @private
     */
    _addNodes: function _addNodes(nodeList, visitedNodes) {
     ...
     * @param {!Set<Node>=} visitedNodes
     */
    _addElement: function _addElement(element, visitedNodes) {
     ...
     * @param {!Set<Node>=} visitedNodes
     */
    _addImport: function _addImport(link, visitedNodes) {
