    ...
    const readme = await DOCS
      ...
      .map(async (p) => {
        ...
        const content = fileContent
          ...
          .replace(RE_LINK, `[$1](${bname}/$2.md)`)
          .replace(RE_DIR, `[$1](./${bname}/$2.md)`)
          .replace(RE_PARENT, `[$1]($2.md)`)
          .replace(RE_REF_LINK, `[$1]: ${bname}/$2.md`)
          .replace(RE_REF_DIR, `[$1]: ./${bname}/$2.md`)
          .replace(RE_REF_PARENT, `[$1]: $2.md`)
          .trim();
