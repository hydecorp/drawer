...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */
var isArray_isArray = Array.isArray || function (x) {
...
function FromEventObservable_isNodeList(sourceObj) {
    return !!sourceObj && FromEventObservable_toString.call(sourceObj) === '[object NodeList]';
}
function FromEventObservable_isHTMLCollection(sourceObj) {
...
var FromEventObservable_FromEventObservable = /*@__PURE__*/ /*@__PURE__*/function (_super) {
    ...
    FromEventObservable.setupSubscription = function (sourceObj, eventName, handler, subscriber, options) {
        var unsubscribe;
        if (FromEventObservable_isNodeList(sourceObj) || FromEventObservable_isHTMLCollection(sourceObj)) {
