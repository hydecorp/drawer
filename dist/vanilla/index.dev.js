        ...
        if (isScheduler(resultSelector)) {
            ...
            return function () {
                ...
                return bindCallback(callbackFunc, scheduler).apply(void 0, args).pipe(map(function (args) {
                    return isArray_isArray(args) ? resultSelector.apply(void 0, args) : resultSelector(args);
                }));
            };
        }
    }
...
function forkJoin() {
    ...
    if (sources.length === 1 && isArray_isArray(sources[0])) {
        sources = sources[0];
    }
    if (sources.length === 0) {
        return EMPTY;
...
function onErrorResumeNext() {
    ...
    if (sources.length === 1 && isArray_isArray(first)) {
