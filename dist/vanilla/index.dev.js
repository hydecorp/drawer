    ...
    _createClass(_class, [{
      ...
      value: function calcWillOpen(_ref3) {
        ...
        switch (this.align) {
          case "left":
            {
              if (velocity > _constants__WEBPACK_IMPORTED_MODULE_0__["VELOCITY_THRESHOLD"]) return true;else if (velocity < -_constants__WEBPACK_IMPORTED_MODULE_0__["VELOCITY_THRESHOLD"]) return false;else if (translateX >= this.drawerWidth / 2) return true;else return false;
            }
          case "right":
            {
              if (-velocity > _constants__WEBPACK_IMPORTED_MODULE_0__["VELOCITY_THRESHOLD"]) return true;else if (-velocity < -_constants__WEBPACK_IMPORTED_MODULE_0__["VELOCITY_THRESHOLD"]) return false;else if (translateX <= -this.drawerWidth / 2) return true;else return false;
  ...
  return function (_setupObservablesMixi) {
    ...
    _createClass(_class, [{
      ...
      value: function setupComponent(el, props) {
        ...
        this.animateTo$ = new rxjs_esm5__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
  ...
  return function (_C) {
    ...
    _createClass(_class, [{
      ...
      value: function getStartObservable() {
        ...
        return Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["combineLatest"])(this.subjects.document, this.subjects.mouseEvents).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (_ref) {
          ...
          var touchstart$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(doc, "touchstart", {
            passive: true
          ...
          var mousedown$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(doc, "mousedown").pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (event) {
      ...
      value: function getMoveObservable(start$, end$) {
        ...
        return Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["combineLatest"])(this.subjects.document, this.subjects.mouseEvents, this.subjects.preventDefault).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (_ref5) {
          ...
          var touchmove$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(doc, "touchmove", { passive: !preventDefault }).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (e) {
          ...
          var mousemove$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(doc, "mousemove", {
      ...
      value: function getEndObservable() {
        // Since the `mouseEvents` option may change at any point, we `switchMap` to reflect the changes.
        return Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["combineLatest"])(this.subjects.document, this.subjects.mouseEvents).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (_ref7) {
          ...
          var touchend$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(doc, "touchend", { passive: true }).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (_ref9) {
          ...
          var mouseup$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(doc, "mouseup", { passive: true });
...
var subscribeWhen = function subscribeWhen(p$) {
  return function (source) {
    ...
    return p$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (p) {
      return p ? source : Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["never"])();
    }));
  };
};
...
var filterWhen = function filterWhen(p$) {
  ...
  return function (source) {
    if (true && !p$) throw Error();else if (others.length === 0) {
      ...
      return source.pipe(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["withLatestFrom"].apply(undefined, [p$].concat(others)), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (_ref5) {
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./constants */ "./src/mixin/constants.js");
/* harmony import */ var _operators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./operators */ "./src/mixin/operators.js");
/* harmony import */ var _calc__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./calc */ "./src/mixin/calc.js");
/* harmony import */ var _update__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./update */ "./src/mixin/update.js");
/* harmony import */ var _observables__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./observables */ "./src/mixin/observables.js");
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
  ...
  return function (_baseObservablesMixin) {
    ...
    _createClass(_class, [{
      ...
      value: function setupObservables() {
        ...
        var resize$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(window, "resize", { passive: true }).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["share"])(), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])({}));

        // Keep measurements up-to-date.
        // Note that we need to temporarily remove the opened class to get the correct measures.
        resize$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect)).subscribe(function () {
        ...
        var start$ = this.getStartObservable().pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(_operators__WEBPACK_IMPORTED_MODULE_5__["filterWhen"])(active$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["share"])());
        ...
        var isScrimVisible$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["defer"])(function () {
          return _this2.translateX$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (translateX) {
            return _this2.align === "left" ? translateX > 0 : translateX < _this2.drawerWidth;
          }));
        });

        // TODO: ...
        var isInRange$ = start$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["withLatestFrom"])(isScrimVisible$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (_ref) {
          var _ref2 = _slicedToArray(_ref, 2),
        ...
        var end$ = this.getEndObservable().pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(_operators__WEBPACK_IMPORTED_MODULE_5__["filterWhen"])(active$, isInRange$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["share"])());

        // #### Move observable
        // The observable of all relevant "move" events.
        var move$ = this.getMoveObservable(start$, end$).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(_operators__WEBPACK_IMPORTED_MODULE_5__["filterWhen"])(active$, isInRange$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["share"])());
        ...
        this.translateX$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["defer"])(function () {
          return Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["merge"])(
          // 1)
          ...
          move$.pipe(Object(_operators__WEBPACK_IMPORTED_MODULE_5__["filterWhen"])(isSliding$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (_ref3) {
            var event = _ref3.event;

            if (_this2.preventDefault) event.preventDefault();
          }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["observeOn"])(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["animationFrameScheduler"]),
          ...
          Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["withLatestFrom"])(start$, _this2.startTranslateX$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (_ref4) {
          ...
          Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["combineLatest"])(_this2.subjects.opened, _this2.subjects.align).pipe(
          ...
          Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (_ref6) {
            var _ref7 = _slicedToArray(_ref6, 1),
                opened = _ref7[0];

            return _this2.cleanupInteraction(opened);
          }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (_ref8) {
        ...
        .pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["share"])());
        ...
        this.startTranslateX$ = this.translateX$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["sample"])(start$));
        ...
        var velocity$ = this.translateX$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["timestamp"])(), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["pairwise"])(),
        ...
        Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (_ref10) {
          var _ref11 = _slicedToArray(_ref10, 2),
        ...
        Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["startWith"])(0));
        ...
        }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["withLatestFrom"])(start$, this.translateX$, velocity$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(this.calcIsSwipe.bind(this)), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(this.calcWillOpen.bind(this)),
        ...
        var tweenTrigger$ = Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["merge"])(willOpen$, this.animateTo$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(this.prepareInteraction.bind(this))));
        ...
        this.tween$ = tweenTrigger$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (willOpen) {
        ...
        Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["withLatestFrom"])(this.translateX$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (_ref14) {
          var _ref15 = _slicedToArray(_ref14, 2),
              opened = _ref15[0],
              translateX = _ref15[1];
          ...
          var duration = _constants__WEBPACK_IMPORTED_MODULE_4__["BASE_DURATION"] + _this2.drawerWidth * _constants__WEBPACK_IMPORTED_MODULE_4__["WIDTH_CONTRIBUTION"];

          return Object(rxjs_create_tween__WEBPACK_IMPORTED_MODULE_2__["createTween"])(_common__WEBPACK_IMPORTED_MODULE_3__["easeOutSine"], translateX, diffTranslateX, duration).pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])({ complete: function complete() {
              return _this2.subjects.opened.next(opened);
            } }), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(start$), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(_this2.subjects.align.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["skip"])(1))), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["share"])());
        }));
        ...
        this.subjects.mouseEvents.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.subjects.disconnect), Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (mouseEvents) {
          ...
          return mouseEvents ? start$.pipe(Object(rxjs_esm5_operators__WEBPACK_IMPORTED_MODULE_1__["withLatestFrom"])(isInRange$)) : Object(rxjs_esm5__WEBPACK_IMPORTED_MODULE_0__["never"])();
    ...
    return _class;
  }(Object(_observables__WEBPACK_IMPORTED_MODULE_8__["baseObservablesMixin"])(Object(_update__WEBPACK_IMPORTED_MODULE_7__["updateMixin"])(Object(_calc__WEBPACK_IMPORTED_MODULE_6__["calcMixin"])(C))));
};
...
var HyDrawer = function (_drawerMixin) {
  _inherits(HyDrawer, _drawerMixin);

  function HyDrawer() {
    _classCallCheck(this, HyDrawer);

    return _possibleConstructorReturn(this, (HyDrawer.__proto__ || Object.getPrototypeOf(HyDrawer)).apply(this, arguments));
  }
  ...
  _createClass(HyDrawer, [{
    ...
    value: function setupShadowDOM(el) {
      ...
      df.appendChild(Object(create_element_x_library__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", { class: "hy-drawer-scrim" }));
      df.appendChild(Object(create_element_x_library__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", { class: "hy-drawer-content" }, el.children));
