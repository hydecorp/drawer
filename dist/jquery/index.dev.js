  ...
  return function (_baseObservablesMixin) {
    ...
    setup__createClass(_class, [{
      ...
      value: function setupObservables() {
        ...
        var move$ = this.getMoveObservable(start$, end$).pipe(observeOn(animationFrame), takeUntil(this.subjects.disconnect), operators_filterWhen(active$, isInRange$), share());
...
defineJQueryComponent("hy.drawer", function (_drawerMixin) {
  jquery__inherits(_class, _drawerMixin);
  ...
  jquery__createClass(_class, [{
    ...
    value: function setupShadowDOM($el) {
      ...
      $el.append(external__jQuery__default()('<div class="hy-drawer-scrim" />')).append(external__jQuery__default()('<div class="hy-drawer-content" />').append(children));
  ...
  return _class;
}(mixin_drawerMixin(JQueryComponent)));
