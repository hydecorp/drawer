...
var HyDrawerElement = function (_customElementMixin) {
  _inherits(HyDrawerElement, _customElementMixin);

  function HyDrawerElement() {
    _classCallCheck(this, HyDrawerElement);

    return _possibleConstructorReturn(this, (HyDrawerElement.__proto__ || Object.getPrototypeOf(HyDrawerElement)).apply(this, arguments));
  }
