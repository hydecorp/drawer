...
var requestAnimationFrameProvider = {
...
function animationFramesFactory(timestampProvider) {
    var schedule = requestAnimationFrameProvider.schedule;
...
function repeatWhen(notifier) {
    return function (source) { return lift(source, new RepeatWhenOperator(notifier)); };
}
...
function sample(notifier) {
    return function (source) { return lift(source, new SampleOperator(notifier)); };
}
...
function skip(count) {
    return function (source) { return lift(source, new SkipOperator(count)); };
}
...
function skipWhile(predicate) {
    return function (source) { return lift(source, new SkipWhileOperator(predicate)); };
}
...
function takeWhile(predicate, inclusive) {
    ...
    return function (source) {
        return lift(source, new TakeWhileOperator(predicate, inclusive));
    };
}
...
function rangeHasChanged(curr, prev = []) {
